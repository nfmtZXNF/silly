...
dialog.lulu-qs-dialog {
  background: var(--SmartThemeBlurTintColor) !important;
  border: 1px solid var(--SmartThemeBorderColor) !important;
  border-radius: 12px;
}
dialog.lulu-qs-dialog::backdrop {
  background: rgba(0,0,0,0.4) !important;
  backdrop-filter: blur(4px) !important;
}

#lulu-quick-snap-modal input[type="text"] {
  background: var(--SmartThemeBotMesColor) !important;
  color: var(--SmartThemeBodyColor) !important;
  border: 1px solid var(--SmartThemeBorderColor) !important;
}

dialog.lulu-qs-dialog .popup-controls .menu_button,
dialog.lulu-qs-dialog .popup-button-ok {
  background: var(--SmartThemeBotMesColor) !important;
  color: var(--SmartThemeBodyColor) !important;
  border: 1px solid var(--SmartThemeQuoteColor) !important;
}
dialog.lulu-qs-dialog .popup-controls .menu_button:hover,
dialog.lulu-qs-dialog .popup-button-ok:hover {
